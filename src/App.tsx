...
export default function App() {
  ...
  const subscribeMeds = useMedicationStore((s) => s.subscribeToMedications);
  const subscribeActs = useActivities((s) => s.subscribeToActivities);

  useEffect(() => {
    const unsubMeds = subscribeMeds();
    const unsubActs = subscribeActs();
